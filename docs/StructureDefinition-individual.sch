...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'https://liberaliscomputing.github.io/pedigree-fhir-ig/StructureDefinition/affected']) &lt;= 1">extension with URL = 'https://liberaliscomputing.github.io/pedigree-fhir-ig/StructureDefinition/affected': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'https://liberaliscomputing.github.io/pedigree-fhir-ig/StructureDefinition/life-status']) &lt;= 1">extension with URL = 'https://liberaliscomputing.github.io/pedigree-fhir-ig/StructureDefinition/life-status': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
